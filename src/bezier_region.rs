...
impl BezierBoundaryLoop2 {
    ...
    /// rational quadratics, and their exact homogeneous degree elevations are
    /// integrated directly. `None` preserves a higher-degree genuinely
    /// rational boundary whose first-moment integral is not yet implemented;
    /// it never requests a flattening tolerance.
